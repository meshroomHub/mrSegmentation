...
RDS_DETECTION_MODEL_PATH=/path/to/imagepromptnnmodels/models/groundingdino_swint_ogc.pth
RDS_RECOGNITION_MODEL_PATH=/path/to/imagepromptnnmodels/models/ram_plus_swin_large_14m.pth
RDS_SEGMENTATION_MODEL_PATH=/path/to/imagepromptnnmodels/models/sam_vit_h_4b8939.pth
RDS_TOKENIZER_PATH=/path/to/imagepromptnnmodels/models/tokenizer
```
